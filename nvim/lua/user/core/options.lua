...
local o = vim.opt -- for keeping it short
...
o.breakindent = true --Every wrapped line will be indented (same amount of space as the beginning of that line)
...
if vim.g.neovide ~= nil then
	...
	-- o.guifont = "JetBrainsMono Nerd Font:h20" -- the font used in graphical neovim applications
	o.guifont = "Cascadia Code,Symbols Nerd Font:h20" -- the font used in graphical neovim applications
	...
	-- option backspace will delete a word in insert mode
