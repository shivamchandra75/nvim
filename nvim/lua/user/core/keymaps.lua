...
-- keymap("n", "<leader>rn", ":IncRename  ", opts) -- ctrl+a to select all

vim.keymap.set("n", "<leader>rn", function()
	return ":IncRename " .. vim.fn.expand("<cword>")
end, { expr = true })

keymap("n", "<leader>y", '"+y', opts) -- paste from clipboard
...
keymap("v", "<", "<gv", opts)
keymap("v", ">", ">gv", opts)
-- keymap("v", "<leader>y", "\"+y", opts) -- yank to clipboard
-- Stay in indent mode
...
-- Lazy
keymap("n", "<leader>lm", "<cmd>Lazy<cr>", {}) -- list available colorscheme
